...
<div class="row col-12 mb-2">
    <div class="update-user card">
        <div class="card-header d-flex justify-content-between">
            <div class="col-8">
            <strong class="page-title">ユーザー更新</strong>
        </div>
...
export default {
    ...
    methods: {
        updateUser() {
            ...
            if(isValid) {
                axios.put("/api/admin/updateuser/" + this.$route.params.id , this.form) 
                .then(response => {
        ...
        loadUserHistory() {
            axios.get("/api/admin/geteditableuser/" + this.$route.params.id) 
                .then(response => {
